...
namespace Illuminate\Support {
    ...
    class Arr {
         ...
         *
         *
         * @see \App\Mixins\ArrMixins::isUnique()
         * @param array $array
         * @static
         */
        public static function isUnique($array)
        {
            return \Illuminate\Support\Arr::isUnique($array);
        }
        /**
         *
         *
         * @see \App\Mixins\ArrMixins::inArray()
         * @param mixed $needle
        ...
        {
            return \Illuminate\Support\Arr::inArray($needle, $haystack);
        }
        /**
         *
         *
         * @see \App\Mixins\ArrMixins::inArrayAny()
         * @param array $needle
         * @param array $haystack
         * @static
         */
        ...
        {
            return \Illuminate\Support\Arr::inArrayAny($needle, $haystack);
        }
    ...
    class Str {
         ...
         *
         *
         * @see \App\Mixins\StrMixins::uniqueString()
         * @param int $limit
         * @static
         */
        public static function uniqueString($limit = 8)
        {
            return \Illuminate\Support\Str::uniqueString($limit);
        }
        /**
         *
         *
         * @see \App\Mixins\StrMixins::toMoneyString()
         * @param mixed $value
         * @static
         */
        public static function toMoneyString($value)
        {
            return \Illuminate\Support\Str::toMoneyString($value);
        }
        /**
         *
         *
         * @see \App\Mixins\StrMixins::toDollarString()
         * @param mixed $value
         * @static
         */
        public static function toDollarString($value)
        {
            return \Illuminate\Support\Str::toDollarString($value);
        }
...
namespace Illuminate\Http\Client {
    ...
    class PendingRequest {
        /**
         * Attach if a file to the request.
         *
         * @param bool $attach
         ...
         * @see \App\Mixins\PendingRequestMixins::attachIf()
         * @static
         */
        public static function attachIf($attach, $name, $contents = '', $filename = null, $headers = [])
        {
            return \Illuminate\Http\Client\PendingRequest::attachIf($attach, $name, $contents, $filename, $headers);
        }
        /**
         * Attach files from request
         *
         * @param string $key
         * @return \Illuminate\Http\Client\PendingRequest
         * @see \App\Mixins\PendingRequestMixins::attachManyFromRequest()
         * @static
         */
        public static function attachManyFromRequest($key = 'images')
        {
            return \Illuminate\Http\Client\PendingRequest::attachManyFromRequest($key);
        }
